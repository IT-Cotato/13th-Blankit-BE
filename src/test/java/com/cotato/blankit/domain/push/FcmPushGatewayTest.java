...
import com.cotato.blankit.domain.push.gateway.FcmPushGateway;
import com.cotato.blankit.domain.push.gateway.PushPayload;
...
class FcmPushGatewayTest {
    ...
    void classifiesUnregisteredAsPermanentTargetFailure() throws Exception {
        ...
        assertThat(result.items().get(0).errorType())
                .isEqualTo(com.cotato.blankit.domain.push.gateway.PushErrorType.PERMANENT_TARGET);
    }
