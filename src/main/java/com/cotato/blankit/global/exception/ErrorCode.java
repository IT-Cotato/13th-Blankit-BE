...
public enum ErrorCode {
    ...
    TIMETABLE_BLOCK_OUTSIDE_DISPLAY_RANGE(HttpStatus.BAD_REQUEST, "TIMETABLE_BLOCK_OUTSIDE_DISPLAY_RANGE", "시간표 블록이 표시 범위를 벗어납니다."),
    ...
    TIMETABLE_INVALID_TIME_UNIT(HttpStatus.BAD_REQUEST, "TIMETABLE_INVALID_TIME_UNIT", "시간은 5분 단위여야 합니다."),
